...
@Component({
  selector: 'app-appointment-dialog-Calendar',
...
export class AppointmentDialogCalendarComponent {
  appointmentForm: FormGroup;
  constructor(
    public dialogRef: MatDialogRef<AppointmentDialogCalendarComponent>,
